...
function doWxss(dir, cb, mainDir, nowDir) {
    ...
    function runVM(name, code) {
        ...
        try {
            ...
            console.error("WXSS extraction runVM failed (VM run error):", e.message);
        }
    ...
    wu.scanDirByExt(dir, ".html", files => {
        ...
        wu.get(frameFile, code => {
            ...
            try {
                ...
                console.error("WXSS extraction failed to parse _C (VM run error). Defaulting to empty pureData.");
                pureData = [];
            }
